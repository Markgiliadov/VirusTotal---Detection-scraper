...
for (let i = 1; i < originDoc.length; i++) {
    const detection = originDoc[i].querySelectorAll("p")[1].className;
    const detectionKey = originDoc[i].querySelectorAll("p")[0].querySelectorAll("span")[0].innerText;
    const detectionVal = originDoc[i].querySelectorAll("p")[1].querySelectorAll('.individual-detection')[0].innerText;
    
    if(detection === "malicious result file"){
